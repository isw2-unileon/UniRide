...
This project expects a root `.env` file for PostgreSQL. If the file does not exist, create it in the repository root with:

```env
POSTGRES_USER=UniRideAdmin
POSTGRES_PASSWORD=UniRide192837465
POSTGRES_DB=UniRide
POSTGRES_PORT=5432
```
